...
async def websocket_endpoint(websocket: WebSocket, session_id: str):
    ...
    try:
        ...
        if clone_result and clone_result.get("workspace_dir"):
            try:
                import shutil
                shutil.rmtree(clone_result["workspace_dir"], ignore_errors=True)
            except Exception as cleanup_error:
                print(f"Could not clean up cloned repository: {cleanup_error}")
